...
png(file = "./plots/version2/out/png/c_size.png")


sizeSATDC <- dataSATDC$size + 1
...
ggplot(dfchart, aes(vector2, values)) + 
  ...
  geom_text(data = meds, aes(y = med, label = (round(med,2) -1)),size = 8, vjust = -0.13,fontface = "bold") + 
